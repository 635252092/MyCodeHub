...
namespace SV.Scm.ScmBE.EntrustedRepairDocBE
{
    ...
    public partial class EntrustedRepairDoc
    {

        #region Custom Constructor
        public override UFIDA.U9.Base.Doc.DocType DocType
        {
            get { return this.SVDocType; }
        }
        #endregion
		...
		*/
        ...
        protected override void OnSetDefaultValue()
        {
            ...
            if (this.BusinessDate == null || this.BusinessDate == DateTime.MinValue)
            {
                this.BusinessDate = DateTime.Now;
            }
            if (this.CurrentNode == CurrentNodeEnum.Empty)
            {
                this.CurrentNode = CurrentNodeEnum.NotCommissioned;
            }
            if (this.DocState == DocStateEnum.Empty)
            {
                this.DocState = DocStateEnum.IsNew;
            }
        ...
        private static EntrustedRepairDoc CreateDefault_Extend()
        {
        ...
        private static EntrustedRepairDoc CreateDefaultComponent_Extend()
        {
            //TODO delete next code and add your custome code here
            throw new NotImplementedException();
        }
